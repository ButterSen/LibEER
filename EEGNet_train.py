...
#    seed dep
#    python EEGNet_train.py -metrics 'acc' 'macro-f1' -model EEGNet -metric_choose 'macro-f1' -setting seed_early_stopping_sub_dep_setting -dataset_path /data1/cxx/SEED数据集/SEED/ -dataset seed_raw -sample_length 200 -stride 200 -only_seg -batch_size 256 -epochs 100 -seed 2024 -lr 0.001 -onehot >EEGNet/b256e100l001.log
#    0.5881/0.1622	0.5441/0.1759
#    seed iv dep
#    python EEGNet_train.py -metrics 'acc' 'macro-f1' -model EEGNet -metric_choose 'macro-f1' -setting seediv_early_stopping_sub_dep_setting -dataset_path /data1/cxx/SEED数据集/SEED_IV -dataset seediv_raw -batch_size 512 -epochs 150 -seed 2024 -sample_length 200 -stride 200 -only_seg -onehot >EEGNet/s4_b512e150l001.log
#    0.2989/0.1353	0.2659/0.1358


#    hci dep
#    arousal
#    CUDA_VISIBLE_DEVICES=2 nohup python EEGNet_train.py -metrics 'acc' 'macro-f1' -model EEGNet -metric_choose 'macro-f1'  -setting hci_early_stopping_sub_dependent_setting -dataset_path "/data1/cxx/HCI数据集/" -dataset hci -batch_size 256 -epochs 300 -lr 0.04 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used arousal -seed 2024 >EEGNet/hci_arousal_b256e300lr0.04.log
#    0.6742/0.2171	0.5450/0.2005
#    valence
#    CUDA_VISIBLE_DEVICES=2 nohup python EEGNet_train.py -metrics 'acc' 'macro-f1' -model EEGNet -metric_choose 'macro-f1'  -setting hci_early_stopping_sub_dependent_setting -dataset_path "/data1/cxx/HCI数据集/" -dataset hci -batch_size 128 -epochs 300 -lr 0.04 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used valence -seed 2024 >EEGNet/hci_valence_b128e300lr0.04.log
...
#    seed iv indep
#    python EEGNet_train.py -metrics 'acc' 'macro-f1' -model EEGNet -metric_choose 'macro-f1' -setting seediv_early_stopping_sub_independent_setting -dataset_path /data1/cxx/SEED数据集/SEED_IV -dataset seediv_raw -batch_size 128 -epochs 150 -seed 2024 -sample_length 200 -stride 200 -only_seg >EEGNet_indep/s4_b128e150.log &
#    28.19%	0.2835


#    hci indep
#    valence
#    CUDA_VISIBLE_DEVICES=1 nohup python EEGNet_train.py -metrics 'acc' 'macro-f1' -model EEGNet -metric_choose 'macro-f1'  -setting hci_early_stopping_sub_independent_setting -dataset_path "/data1/cxx/HCI数据集/" -dataset hci -batch_size 256 -epochs 300 -lr 0.04 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used valence -seed 2024 >EEGNet_indep/hci_valence_b256e300lr0.04.log
#    0.5706	0.5383
#    arousal
#    CUDA_VISIBLE_DEVICES=1 nohup python EEGNet_train.py -metrics 'acc' 'macro-f1' -model EEGNet -metric_choose 'macro-f1'  -setting hci_early_stopping_sub_independent_setting -dataset_path "/data1/cxx/HCI数据集/" -dataset hci -batch_size 512 -epochs 300 -lr 0.02 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used arousal -seed 2024 >EEGNet_indep/hci_arousal_b512e300lr0.02.log
#    0.547	0.5402
#    both
#    CUDA_VISIBLE_DEVICES=1 nohup python EEGNet_train.py -metrics 'acc' 'macro-f1' -model EEGNet -metric_choose 'macro-f1'  -setting hci_early_stopping_sub_independent_setting -dataset_path "/data1/cxx/HCI数据集/" -dataset hci -batch_size 256 -epochs 300 -lr 0.02 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used valence arousal -seed 2024 >EEGNet_indep/hci_both_b256e300lr0.02.log
#    0.3484	0.2796
