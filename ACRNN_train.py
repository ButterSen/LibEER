...
from config.setting import deap_sub_dependent_setting, preset_setting, set_setting_by_args
...
# run this file with
#   CUDA_VISIBLE_DEVICES=3 nohup python ACRNN_train.py -setting deap_sub_dependent_setting -only_seg -cross_trail false -dataset_path '/date1/yss/data/DEAP数据集/data_preprocessed_python' -dataset deap -sample_length 384 -stride 384 -bounds 5 5 -fold_num 10 -fold_shuffle false -label_used valence -batch_size 10 -lr 10e-4 -epochs 200 -onehot > ACRNN/valence_reproduction.log
#   CUDA_VISIBLE_DEVICES=3 nohup python ACRNN_train.py -setting deap_sub_dependent_setting -only_seg -cross_trail false -dataset_path /data1/cxx/DEAP/data_preprocessed_python -dataset deap -sample_length 384 -stride 384 -bounds 5 5 -fold_num 10 -fold_shuffle false -label_used valence -batch_size 16 -lr 10e-4 -epochs 1000 -onehot > ACRNN/valence_reproduction.log

#   deap dep
#   arousal
#   CUDA_VISIBLE_DEVICES=2 nohup python ACRNN_train.py -metrics 'acc' 'macro-f1' -model ACRNN -metric_choose 'macro-f1' -setting deap_early_stopping_sub_dependent_setting -dataset_path /data1/cxx/DEAP/data_preprocessed_python -dataset deap -batch_size 16 -epochs 1000 -lr 0.001 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used arousal -seed 2024 >ACRNN/deap_arousal_b16e1000lr0.001.log
...
#   hci dep
#   arousal
#   CUDA_VISIBLE_DEVICES=2 nohup python ACRNN_train.py -metrics 'acc' 'macro-f1' -model ACRNN -metric_choose 'macro-f1'  -setting hci_early_stopping_sub_dependent_setting -dataset_path "/data1/cxx/HCI数据集/" -dataset hci  -batch_size 16 -epochs 1000 -lr 0.001 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used arousal -seed 2024 >ACRNN/hci_arousal_b16e1000lr0.001.log
...
#   seed dep
#   python ACRNN_train.py -metrics 'acc' 'macro-f1' -model ACRNN -metric_choose 'macro-f1' -setting seed_early_stopping_sub_dep_setting -dataset_path /data1/cxx/SEED数据集/SEED/ -dataset seed_raw -sample_length 200 -stride 200 -only_seg -lr 10e-4 -batch_size 16 -epochs 1000 -seed 2024 >ACRNN/b16e1000.log
#   0.4971/0.1315	0.4578/0.1418
#   seed iv dep
#   CUDA_VISIBLE_DEVICES=2 nohup python ACRNN_train.py -metrics 'acc' 'macro-f1' -model ACRNN -metric_choose 'macro-f1'  -setting hci_early_stopping_sub_dependent_setting -dataset_path "/data1/cxx/HCI数据集/" -dataset hci -batch_size 16 -epochs 1000 -lr 0.001 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used valence arousal -seed 2024 >ACRNN/hci_both_b16e1000lr0.001.log#   0.2901/0.0710	0.1980/0.0542

#   seed indep
#   python ACRNN_train.py -metrics 'acc' 'macro-f1' -model ACRNN -metric_choose 'macro-f1' -setting seed_early_stopping_sub_independent_setting -dataset_path /data1/cxx/SEED数据集/SEED/ -dataset seed_raw -sample_length 200 -stride 200 -only_seg -lr 10e-4 -batch_size 16 -epochs 1000 -seed 2024 >ACRNN_indep/b16e1000.log
#   0.4539	0.4237
#   seed iv indep
#
#   0.3197	0.1882
...
#   hci indep
#   valence
#   CUDA_VISIBLE_DEVICES=0 nohup python ACRNN_train.py -metrics 'acc' 'macro-f1' -model ACRNN -metric_choose 'macro-f1'  -setting hci_early_stopping_sub_independent_setting -dataset_path "/data1/cxx/HCI数据集/" -dataset hci -batch_size 16 -epochs 1000 -lr 0.001 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used valence -seed 2024 >ACRNN_indep/hci_valence_b16e1000lr0.001.log
#   0.5453	0.5258
#   arousal
...
#   deap indep
#   valence
#   CUDA_VISIBLE_DEVICES=3 nohup python ACRNN_train.py -metrics 'acc' 'macro-f1' -model ACRNN -metric_choose 'macro-f1' -setting deap_early_stopping_sub_independent_setting -dataset_path /data1/cxx/DEAP/data_preprocessed_python -dataset deap -batch_size 16 -epochs 1000 -lr 0.001 -only_seg -sample_length 128 -stride 128 -bounds 5 5 -label_used valence -seed 2024 >ACRNN_indep/deap_valence_b16e1000lr0.001.log
#   0.5194	0.4737
#   arousal
...
def main(args):
    ...
    # setting = deap_sub_dependent_setting(args)
